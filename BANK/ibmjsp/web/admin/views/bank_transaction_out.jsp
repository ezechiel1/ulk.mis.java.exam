                  ...
                  <div class="x_title">
                    <h2>
                        <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#register"> <i class="fa fa-plus"></i> 
                            Register New Customer Bank Transaction Out
                        </button>
                    </h2>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                            ...
                            <h4 class="modal-title" id="myModalLabel"> IBM Bank <span class="text-muted"> | IBM Customer Transaction Cash Out</span></h4>
                        </div>
                   <form action="control/bankTransactionCashOutController.jsp" method="post">
                     <div class="modal-body">
